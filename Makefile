...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_calcs
	python -m ruff format --check finance_calcs
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_calcs
	python -m ruff format finance_calcs
...
test-py:  ## run python tests
	python -m pytest -v finance_calcs/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_calcs/tests --cov=finance_calcs --cov-report term-missing --cov-report xml
...
docs-clean:  ## remove built documentation
	rm -rf _build docs/_build docs/html site
